                        ...
                        <form method="post" action="/" id="custom-form-wizard">
                            <div class="wizard steps-bg steps-left">
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40">Employee Full Name </h6></label>
                                        <label for="input002" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40"> Identification Card Number </h6></label>
                                        <label for="input002" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                            ...
                                            @else
                                                <input type="text" placeholder="IC" name="pan_number"
