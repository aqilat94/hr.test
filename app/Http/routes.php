...
Route::group(['middleware' => ['guest']], function ()
{
    ...
    Route::get('stafflogin', 'AuthStaffController@showLogin');
    
    Route::post('stafflogin', 'AuthStaffController@doLogin');
});
...
Route::group(['middleware' => ['auth']], function ()
{
    ...
    Route::get('message-noti', 'NotificationController@showmessage');
    
    Route::post('message-noti', 'NotificationController@showmessage'); 
